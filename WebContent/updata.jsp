...
<center>
		...
		<input type="hidden" name="computer.com_id" value="${id}">
			<table>
				<tr>
					<td>电脑型号:</td>
					<td><input type="text" id="type_name" name="computer.com_name"  value="${name}"></td>
				</tr>
				<tr>
					<td>cpu:</td>
				...
				<tr>
					<td>价格:</td>
					<td><input type="text" name="computer.price" id="price"  value="${price}"></td>
				</tr>
				<tr>
